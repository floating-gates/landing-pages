    ...
    >
      ...
      >
        <div
          ...
          @click.stop
        >
          <div class="flex items-center justify-between p-6 md:p-8 pb-4 border-bottom border-black/10">
          ...
          <div class="flex-1 overflow-y-auto p-6 md:p-8 pt-4 grid place-items-center">
            <img
...
/* Keeping only the essential custom elements not completely natively targetable inline */
...
/* Fallback handling for nested rich HTML tags inside dynamically split text blocks */
